...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Sa,depthTest:!1,depthWrite:!1})}function _1(r,t,n){const s=new Float32Array(Ps),l=new nt(0,1,0);return new ji({name:"SphericalGaussianBlur",defines:{n:Ps,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:hu(),fragmentShader:`
	...
	`}function v1(r){let t=new WeakMap,n=null;function s(h){if(h&&h.isTexture){const m=h.mapping,p=m===pd||m===md,_=m===Bs||m===qr;if(p||_){let g=t.get(h);const x=g!==void 0?g.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==x)return n===null&&(n=new Y_(r)),g=p?n.fromEquirectangular(h,g):n.fromCubemap(h,g),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),g.texture;if(g!==void 0)return g.texture;{const M=h.image;return p&&M&&M.height>0||_&&M&&l(M)?(n===null&&(n=new Y_(r)),g=p?n.fromEquirectangular(h):n.fromCubemap(h),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),h.addEventListener("dispose",c),g.texture):null}}}return h}function l(h){let m=0;const p=6;for(let _=0;_<p;_++)h[_]!==void 0&&m++;return m===p}function c(h){const m=h.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function f(){t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:f}}function x1(r){const t={};function n(s){if(t[s]!==void 0)return t[s];const l=r.getExtension(s);return t[s]=l,l}return{has:function(s){return n(s)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(s){const l=n(s);return l===null&&cl("WebGLRenderer: "+s+" extension not supported."),l}}}function y1(r,t,n,s){const l={},c=new WeakMap;function f(g){const x=g.target;x.index!==null&&t.remove(x.index);for(const b in x.attributes)t.remove(x.attributes[b]);x.removeEventListener("dispose",f),delete l[x.id];const M=c.get(x);M&&(t.remove(M),c.delete(x)),s.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,n.memory.geometries--}function h(g,x){return l[x.id]===!0||(x.addEventListener("dispose",f),l[x.id]=!0,n.memory.geometries++),x}function m(g){const x=g.attributes;for(const M in x)t.update(x[M],r.ARRAY_BUFFER)}function p(g){const x=[],M=g.index,b=g.attributes.position;let A=0;if(M!==null){const P=M.array;A=M.version;for(let w=0,N=P.length;w<N;w+=3){const F=P[w+0],H=P[w+1],z=P[w+2];x.push(F,H,H,z,z,F)}}else if(b!==void 0){const P=b.array;A=b.version;for(let w=0,N=P.length/3-1;w<N;w+=3){const F=w+0,H=w+1,z=w+2;x.push(F,H,H,z,z,F)}}else return;const y=new(Nv(x)?Hv:Bv)(x,1);y.version=A;const v=c.get(g);v&&t.remove(v),c.set(g,y)}function _(g){const x=c.get(g);if(x){const M=g.index;M!==null&&x.version<M.version&&p(g)}else p(g);return c.get(g)}return{get:h,update:m,getWireframeAttribute:_}}function S1(r,t,n){let s;function l(x){s=x}let c,f;function h(x){c=x.type,f=x.bytesPerElement}function m(x,M){r.drawElements(s,M,c,x*f),n.update(M,s,1)}function p(x,M,b){b!==0&&(r.drawElementsInstanced(s,M,c,x*f,b),n.update(M,s,b))}function _(x,M,b){if(b===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,M,0,c,x,0,b);let y=0;for(let v=0;v<b;v++)y+=M[v];n.update(y,s,1)}function g(x,M,b,A){if(b===0)return;const y=t.get("WEBGL_multi_draw");if(y===null)for(let v=0;v<x.length;v++)p(x[v]/f,M[v],A[v]);else{y.multiDrawElementsInstancedWEBGL(s,M,0,c,x,0,A,0,b);let v=0;for(let P=0;P<b;P++)v+=M[P]*A[P];n.update(v,s,1)}}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=_,this.renderMultiDrawInstances=g}function M1(r){const t={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,h){switch(n.calls++,f){case r.TRIANGLES:n.triangles+=h*(c/3);break;case r.LINES:n.lines+=h*(c/2);break;case r.LINE_STRIP:n.lines+=h*(c-1);break;case r.LINE_LOOP:n.lines+=h*c;break;case r.POINTS:n.points+=h*c;break;default:Ue("WebGLInfo: Unknown draw mode:",f);break}}function l(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:t,render:n,programs:null,autoReset:!0,reset:l,update:s}}function E1(r,t,n){const s=new WeakMap,l=new sn;function c(f,h,m){const p=f.morphTargetInfluences,_=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,g=_!==void 0?_.length:0;let x=s.get(h);if(x===void 0||x.count!==g){let O=function(){Z.dispose(),s.delete(h),h.removeEventListener("dispose",O)};var M=O;x!==void 0&&x.texture.dispose();const b=h.morphAttributes.position!==void 0,A=h.morphAttributes.normal!==void 0,y=h.morphAttributes.color!==void 0,v=h.morphAttributes.position||[],P=h.morphAttributes.normal||[],w=h.morphAttributes.color||[];let N=0;b===!0&&(N=1),A===!0&&(N=2),y===!0&&(N=3);let F=h.attributes.position.count*N,H=1;F>t.maxTextureSize&&(H=Math.ceil(F/t.maxTextureSize),F=t.maxTextureSize);const z=new Float32Array(F*H*4*g),Z=new Ov(z,F,H,g);Z.type=Gi,Z.needsUpdate=!0;const D=N*4;for(let q=0;q<g;q++){const $=v[q],ot=P[q],gt=w[q],dt=F*H*4*q;for(let V=0;V<$.count;V++){const k=V*D;b===!0&&(l.fromBufferAttribute($,V),z[dt+k+0]=l.x,z[dt+k+1]=l.y,z[dt+k+2]=l.z,z[dt+k+3]=0),A===!0&&(l.fromBufferAttribute(ot,V),z[dt+k+4]=l.x,z[dt+k+5]=l.y,z[dt+k+6]=l.z,z[dt+k+7]=0),y===!0&&(l.fromBufferAttribute(gt,V),z[dt+k+8]=l.x,z[dt+k+9]=l.y,z[dt+k+10]=l.z,z[dt+k+11]=gt.itemSize===4?l.w:1)}}x={count:g,texture:Z,size:new Ut(F,H)},s.set(h,x),h.addEventListener("dispose",O)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,n);else{let b=0;for(let y=0;y<p.length;y++)b+=p[y];const A=h.morphTargetsRelative?1:1-b;m.getUniforms().setValue(r,"morphTargetBaseInfluence",A),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",x.texture,n),m.getUniforms().setValue(r,"morphTargetsTextureSize",x.size)}return{update:c}}function b1(r,t,n,s){let l=new WeakMap;function c(m){const p=s.render.frame,_=m.geometry,g=t.get(m,_);if(l.get(g)!==p&&(t.update(g),l.set(g,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",h)===!1&&m.addEventListener("dispose",h),l.get(m)!==p&&(n.update(m.instanceMatrix,r.ARRAY_BUFFER),m.instanceColor!==null&&n.update(m.instanceColor,r.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const x=m.skeleton;l.get(x)!==p&&(x.update(),l.set(x,p))}return g}function f(){l=new WeakMap}function h(m){const p=m.target;p.removeEventListener("dispose",h),n.remove(p.instanceMatrix),p.instanceColor!==null&&n.remove(p.instanceColor)}return{update:c,dispose:f}}const T1={[_v]:"LINEAR_TONE_MAPPING",[vv]:"REINHARD_TONE_MAPPING",[xv]:"CINEON_TONE_MAPPING",[yv]:"ACES_FILMIC_TONE_MAPPING",[Mv]:"AGX_TONE_MAPPING",[Ev]:"NEUTRAL_TONE_MAPPING",[Sv]:"CUSTOM_TONE_MAPPING"};function A1(r,t,n,s,l){const c=new Xi(t,n,{type:r,depthBuffer:s,stencilBuffer:l}),f=new Xi(t,n,{type:Ea,depthBuffer:!1,stencilBuffer:!1}),h=new yi;h.setAttribute("position",new Ln([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new Ln([0,2,0,0,2,0],2));const m=new fE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),p=new Li(h,m),_=new yp(-1,1,1,-1,0,1);let g=null,x=null,M=!1,b,A=null,y=[],v=!1;this.setSize=function(P,w){c.setSize(P,w),f.setSize(P,w);for(let N=0;N<y.length;N++){const F=y[N];F.setSize&&F.setSize(P,w)}},this.setEffects=function(P){y=P,v=y.length>0&&y[0].isRenderPass===!0;const w=c.width,N=c.height;for(let F=0;F<y.length;F++){const H=y[F];H.setSize&&H.setSize(w,N)}},this.begin=function(P,w){if(M||P.toneMapping===ki&&y.length===0)return!1;if(A=w,w!==null){const N=w.width,F=w.height;(c.width!==N||c.height!==F)&&this.setSize(N,F)}return v===!1&&P.setRenderTarget(c),b=P.toneMapping,P.toneMapping=ki,!0},this.hasRenderPass=function(){return v},this.end=function(P,w){P.toneMapping=b,M=!0;let N=c,F=f;for(let H=0;H<y.length;H++){const z=y[H];if(z.enabled!==!1&&(z.render(P,F,N,w),z.needsSwap!==!1)){const Z=N;N=F,F=Z}}if(g!==P.outputColorSpace||x!==P.toneMapping){g=P.outputColorSpace,x=P.toneMapping,m.defines={},Le.getTransfer(g)===ke&&(m.defines.SRGB_TRANSFER="");const H=T1[x];H&&(m.defines[H]=""),m.needsUpdate=!0}m.uniforms.tDiffuse.value=N.texture,P.setRenderTarget(A),P.render(p,_),A=null,M=!1},this.isCompositing=function(){return M},this.dispose=function(){c.dispose(),f.dispose(),h.dispose(),m.dispose()}}const nx=new Gn,tp=new ul(1,1),ix=new Ov,ax=new lM,sx=new kv,Q_=[],J_=[],$_=new Float32Array(16),tv=new Float32Array(9),ev=new Float32Array(4);function Jr(r,t,n){const s=r[0];if(s<=0||s>0)return r;const l=t*n;let c=Q_[l];if(c===void 0&&(c=new Float32Array(l),Q_[l]=c),t!==0){s.toArray(c,0);for(let f=1,h=0;f!==t;++f)h+=n,r[f].toArray(c,h)}return c}function _n(r,t){if(r.length!==t.length)return!1;for(let n=0,s=r.length;n<s;n++)if(r[n]!==t[n])return!1;return!0}function vn(r,t){for(let n=0,s=t.length;n<s;n++)r[n]=t[n]}function du(r,t){let n=J_[t];n===void 0&&(n=new Int32Array(t),J_[t]=n);for(let s=0;s!==t;++s)n[s]=r.allocateTextureUnit();return n}function R1(r,t){const n=this.cache;n[0]!==t&&(r.uniform1f(this.addr,t),n[0]=t)}function C1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(_n(n,t))return;r.uniform2fv(this.addr,t),vn(n,t)}}function w1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(_n(n,t))return;r.uniform3fv(this.addr,t),vn(n,t)}}function D1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(_n(n,t))return;r.uniform4fv(this.addr,t),vn(n,t)}}function U1(r,t){const n=this.cache,s=t.elements;if(s===void 0){if(_n(n,t))return;r.uniformMatrix2fv(this.addr,!1,t),vn(n,t)}else{if(_n(n,s))return;ev.set(s),r.uniformMatrix2fv(this.addr,!1,ev),vn(n,s)}}function L1(r,t){const n=this.cache,s=t.elements;if(s===void 0){if(_n(n,t))return;r.uniformMatrix3fv(this.addr,!1,t),vn(n,t)}else{if(_n(n,s))return;tv.set(s),r.uniformMatrix3fv(this.addr,!1,tv),vn(n,s)}}function N1(r,t){const n=this.cache,s=t.elements;if(s===void 0){if(_n(n,t))return;r.uniformMatrix4fv(this.addr,!1,t),vn(n,t)}else{if(_n(n,s))return;$_.set(s),r.uniformMatrix4fv(this.addr,!1,$_),vn(n,s)}}function O1(r,t){const n=this.cache;n[0]!==t&&(r.uniform1i(this.addr,t),n[0]=t)}function P1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(_n(n,t))return;r.uniform2iv(this.addr,t),vn(n,t)}}function I1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(_n(n,t))return;r.uniform3iv(this.addr,t),vn(n,t)}}function z1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(_n(n,t))return;r.uniform4iv(this.addr,t),vn(n,t)}}function F1(r,t){const n=this.cache;n[0]!==t&&(r.uniform1ui(this.addr,t),n[0]=t)}function B1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(_n(n,t))return;r.uniform2uiv(this.addr,t),vn(n,t)}}function H1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(_n(n,t))return;r.uniform3uiv(this.addr,t),vn(n,t)}}function G1(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(_n(n,t))return;r.uniform4uiv(this.addr,t),vn(n,t)}}function V1(r,t,n){const s=this.cache,l=n.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(tp.compareFunction=n.isReversedDepthBuffer()?fp:up,c=tp):c=nx,n.setTexture2D(t||c,l)}function k1(r,t,n){const s=this.cache,l=n.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),n.setTexture3D(t||ax,l)}function X1(r,t,n){const s=this.cache,l=n.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),n.setTextureCube(t||sx,l)}function W1(r,t,n){const s=this.cache,l=n.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),n.setTexture2DArray(t||ix,l)}function q1(r){switch(r){case 5126:return R1;case 35664:return C1;case 35665:return w1;case 35666:return D1;case 35674:return U1;case 35675:return L1;case 35676:return N1;case 5124:case 35670:return O1;case 35667:case 35671:return P1;case 35668:case 35672:return I1;case 35669:case 35673:return z1;case 5125:return F1;case 36294:return B1;case 36295:return H1;case 36296:return G1;case 35678:case 36198:case 36298:case 36306:case 35682:return V1;case 35679:case 36299:case 36307:return k1;case 35680:case 36300:case 36308:case 36293:return X1;case 36289:case 36303:case 36311:case 36292:return W1}}function Y1(r,t){r.uniform1fv(this.addr,t)}function j1(r,t){const n=Jr(t,this.size,2);r.uniform2fv(this.addr,n)}function Z1(r,t){const n=Jr(t,this.size,3);r.uniform3fv(this.addr,n)}function K1(r,t){const n=Jr(t,this.size,4);r.uniform4fv(this.addr,n)}function Q1(r,t){const n=Jr(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,n)}function J1(r,t){const n=Jr(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,n)}function $1(r,t){const n=Jr(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,n)}function tA(r,t){r.uniform1iv(this.addr,t)}function eA(r,t){r.uniform2iv(this.addr,t)}function nA(r,t){r.uniform3iv(this.addr,t)}function iA(r,t){r.uniform4iv(this.addr,t)}function aA(r,t){r.uniform1uiv(this.addr,t)}function sA(r,t){r.uniform2uiv(this.addr,t)}function rA(r,t){r.uniform3uiv(this.addr,t)}function oA(r,t){r.uniform4uiv(this.addr,t)}function lA(r,t,n){const s=this.cache,l=t.length,c=du(n,l);_n(s,c)||(r.uniform1iv(this.addr,c),vn(s,c));let f;this.type===r.SAMPLER_2D_SHADOW?f=tp:f=nx;for(let h=0;h!==l;++h)n.setTexture2D(t[h]||f,c[h])}function cA(r,t,n){const s=this.cache,l=t.length,c=du(n,l);_n(s,c)||(r.uniform1iv(this.addr,c),vn(s,c));for(let f=0;f!==l;++f)n.setTexture3D(t[f]||ax,c[f])}function uA(r,t,n){const s=this.cache,l=t.length,c=du(n,l);_n(s,c)||(r.uniform1iv(this.addr,c),vn(s,c));for(let f=0;f!==l;++f)n.setTextureCube(t[f]||sx,c[f])}function fA(r,t,n){const s=this.cache,l=t.length,c=du(n,l);_n(s,c)||(r.uniform1iv(this.addr,c),vn(s,c));for(let f=0;f!==l;++f)n.setTexture2DArray(t[f]||ix,c[f])}function hA(r){switch(r){case 5126:return Y1;case 35664:return j1;case 35665:return Z1;case 35666:return K1;case 35674:return Q1;case 35675:return J1;case 35676:return $1;case 5124:case 35670:return tA;case 35667:case 35671:return eA;case 35668:case 35672:return nA;case 35669:case 35673:return iA;case 5125:return aA;case 36294:return sA;case 36295:return rA;case 36296:return oA;case 35678:case 36198:case 36298:case 36306:case 35682:return lA;case 35679:case 36299:case 36307:return cA;case 35680:case 36300:case 36308:case 36293:return uA;case 36289:case 36303:case 36311:case 36292:return fA}}class dA{constructor(t,n,s){this.id=t,this.addr=s,this.cache=[],this.type=n.type,this.setValue=q1(n.type)}}class pA{constructor(t,n,s){this.id=t,this.addr=s,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=hA(n.type)}}class mA{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,n,s){const l=this.seq;for(let c=0,f=l.length;c!==f;++c){const h=l[c];h.setValue(t,n[h.id],s)}}}const nd=/(\w+)(\])?(\[|\.)?/g;function nv(r,t){r.seq.push(t),r.map[t.id]=t}function gA(r,t,n){const s=r.name,l=s.length;for(nd.lastIndex=0;;){const c=nd.exec(s),f=nd.lastIndex;let h=c[1];const m=c[2]==="]",p=c[3];if(m&&(h=h|0),p===void 0||p==="["&&f+2===l){nv(n,p===void 0?new dA(h,r,t):new pA(h,r,t));break}else{let g=n.map[h];g===void 0&&(g=new mA(h),nv(n,g)),n=g}}}class au{constructor(t,n){this.seq=[],this.map={};const s=t.getProgramParameter(n,t.ACTIVE_UNIFORMS);for(let f=0;f<s;++f){const h=t.getActiveUniform(n,f),m=t.getUniformLocation(n,h.name);gA(h,m,this)}const l=[],c=[];for(const f of this.seq)f.type===t.SAMPLER_2D_SHADOW||f.type===t.SAMPLER_CUBE_SHADOW||f.type===t.SAMPLER_2D_ARRAY_SHADOW?l.push(f):c.push(f);l.length>0&&(this.seq=l.concat(c))}setValue(t,n,s,l){const c=this.map[n];c!==void 0&&c.setValue(t,s,l)}setOptional(t,n,s){const l=n[s];l!==void 0&&this.setValue(t,s,l)}static upload(t,n,s,l){for(let c=0,f=n.length;c!==f;++c){const h=n[c],m=s[h.id];m.needsUpdate!==!1&&h.setValue(t,m.value,l)}}static seqWithValue(t,n){const s=[];for(let l=0,c=t.length;l!==c;++l){const f=t[l];f.id in n&&s.push(f)}return s}}function iv(r,t,n){const s=r.createShader(t);return r.shaderSource(s,n),r.compileShader(s),s}const _A=37297;let vA=0;function xA(r,t){const n=r.split(`
